  ...
  return (
    <div className="bg fixed top-0 w-full">
      <div className="navbar lg:h-[70px]">
        ...
        <div className="flex flex-row gap-2">
          ...
          >
            ...
            <NavLink to="/about" className="primary-h">
              About
            </NavLink>
            <span className="primary">|</span>
            <a href="https://www.instagram.com/wicheriani/" className="flex">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill=" #FD8791"
                width="20"
                className="bi bi-instagram svg"
                viewBox="0 0 16 16"
              >
          ...
          <div id="bar-on">
            <div onClick={active}>
              {!nav ? (
                <Bars3Icon className="h-7 w-7 primary" />
              ) : (
                <XMarkIcon className="h-7 w-7 primary" />
              )}
            </div>
          </div>
        </div>
      ...
      <div
        className={
          !nav
            ? "fixed left-[-100%] w-full bg ease-in duration-300"
            : "fixed left-[0%] w-full bg ease-in duration-300"
        }
      >
        <div className="menu flex text-center flex-col align-middle gap-5 text-lg font-semibold tracking-wide h-[100vh] pt-[100px]">
          ...
          <span className="primary">-</span>
          <a
            href="https://www.instagram.com/wicheriani/"
            className="flex justify-center gap-1 primary"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill=" #FD8791"
